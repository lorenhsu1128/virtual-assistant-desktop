...
| Group | 實測點數 | 目標 | 是否通過 |
|---|---|---|---|
| poseLandmarks | _ | 33 | V |
| leftHandLandmarks | _ | 21 | V |
| rightHandLandmarks | _ | 21 | V |
| faceLandmarks | _ | 478（含虹膜） | V |

### Spike A 結論

- [V] **GPU delegate 可用**
- [V] **單幀延遲達到 30fps 即時標準**
- [V] **四個 landmark group 都正常回傳**
- [V] **手指 landmarks 在身體動作快時仍穩定**
- [V] **整體可以支撐 Stage 1 即時預覽全身骨架**
...
- [V] **Part 2 讀回成功**
- [V] **Part 3 視覺驗證全部正確**
- [V] **方案 2（GLTFExporter + extension 注入）確認可行**
...
- [V] **✅ A + B 都成功** → 進入 Phase 1：視窗骨架（按原計畫）
